...
class MediaPartnerView(EsportsBaseView):
    ...
    async def initial_embed(self):
        ...
        embed.description = (
            "With media-partnership you can make Quo x handle media partner registrations "
            "that means in Quo x will check if the user have registered in the partner server "
